...
class FriendFavAdapter (private  val context: Context, private  val items:ArrayList<Stock>)
    : RecyclerView.Adapter<RecyclerView.ViewHolder> () {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.friend_fav_item_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.textViewItemAdd).setOnClickListener {
            UserManager.addFavorite(context, item){
