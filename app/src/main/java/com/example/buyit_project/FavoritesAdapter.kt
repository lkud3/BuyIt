...
class FavoritesAdapter (private  val context: Context, private  val items:ArrayList<Stock>)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.textViewItemRemove).setOnClickListener {
            UserManager.currentUser.favouriteItems.remove(item)
            notifyDataSetChanged()
            UserManager.removeFavorite(context){
